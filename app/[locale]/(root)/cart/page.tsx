					...
					<>
						<div className='col-span-3'>
							<Card className='rounded-none'>
								<CardHeader className='pb-0 text-3xl'>
									{t('Cart.Shopping Cart')}
								</CardHeader>

								<CardContent className='p-4'>
									<div className='mb-4 flex justify-end border-b'>
										{t('Cart.Price')}
									</div>
									...
									{items.map((item) => (
										<div
											key={item.clientId}
											className='flex flex-col justify-between gap-4 border-b py-4 md:flex-row'
										>
									...
									<div className='my-2 flex justify-end text-lg'>
										{t('Cart.Subtotal')} (
